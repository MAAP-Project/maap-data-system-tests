...
describe('UMF (questionaire) ui', () => {
  ...
  it('should have populated blurb', () => {
    cy.get('body > div > div > div > div > div.details_holder > p:nth-child(1)')
      .should('have.text', 'Thank you for sharing your data with the MAAP community! As a reminder, data shared through this process should be provided by you. You are responsible for any content you upload to the MAAP and please do not post content that isn’t your own.')
  })
